...
def _extract_domain(url_or_domain: str) -> str:
    ...
    'https://avyn.io/about' and 'avyn.io' both return 'avyn.io'."""
...
# was unreachable. That is the exact miss on Mateusz Pniewski at transactionlink.io,
# whose real address is mpniewski@ and which a single search returns as its first
# result.
EMAIL_PATTERNS = [
    "{first}.{last}",
    "{f}{last}",
...
def resolve_company_domain(name: str, given_website: str | None,
    ...
    system = (
        ...
        '{"domain": "avyn.io", "confidence": "high|medium|low", "why": "one short line", '
