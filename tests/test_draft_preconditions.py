...
Observed: Synaps was composed with contact_first="Unknown", a pattern-guessed unknown@synaps.com and
...
def _ok_cache():
    return {"company": {"name": "Synaps", "what_they_do": "e-commerce listing automation",
                        "resolved_domain": "synaps.com"},
            "contact": {"name": "Ada Lovelace", "email": "ada@synaps.com",
...
def test_unknown_local_part_blocks():
    c = _ok_cache(); c["contact"]["email"] = "unknown@synaps.com"
    assert preflight.blockers(c)
