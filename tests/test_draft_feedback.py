...
AVYN = ("Having judged companies from the investor side and also built sourcing pipelines and "
        "automation for private markets myself, Avyn really stood out to me.")
...
def test_copied_scaffold_produces_an_instruction():
    body = ("Having judged companies from the investor side at HPE Growth and also built an end to "
            "end LLM pipeline at BlueFire AI, Webyn really stood out to me.")
...
def test_sender_heavy_feedback_states_the_correction():
    body = ("Having judged companies at HPE Growth and built an LLM pipeline at BlueFire AI, my "
